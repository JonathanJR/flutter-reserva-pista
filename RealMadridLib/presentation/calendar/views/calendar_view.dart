...
import 'package:rm_app_flutter_fan/presentation/calendar/notifier/calendar_notifier.dart';
...
class CalendarPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final userIsLoaded = ref.read(calendarNotifierProvider).isUserLogged;
    return RMScaffold(
      ...
      bodyBuilder: (_) => RMBody(
        ...
        topSafe: true,
        child: Text('calendar $userIsLoaded'),
      ),
    );
  }
}
